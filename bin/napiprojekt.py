...
urlstr = "http://napiprojekt.pl/unit_napisy/dl.php?l=PL&f="+d.hexdigest()+"&t="+f(d.hexdigest())+"&v=other&kolejka=false&nick=&pass=&napios="+os.name
print urlstr
open("napisy.7z","w").write(urllib.urlopen(urlstr).read())
